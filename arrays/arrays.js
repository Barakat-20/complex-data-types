...
addzero = growMe.unshift("zero")
addthree = growMe.push("three")
...
removeme = shrinkMe.shift()
removeme = shrinkMe.pop()
...
arrayinsert = insertIntoMe.splice(1, 0, "that", "was")
...
arrayremove = removeFromMe.splice(2, 3)
